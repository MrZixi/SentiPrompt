...
class BartEncoder(nn.Module):
    ...
    def forward(
            self, input_ids=None, attention_mask=None, output_attentions=False, output_hidden_states=False, return_dict=False, input_embs=None
    ):
        """
        Args:
        ...
        if input_embs is not None:
            inputs_embeds = input_embs * self.embed_scale
        else:
